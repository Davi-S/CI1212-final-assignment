...
```
Observação: Apenas a etapa de geração de gráficos foi implementada em Python, para fins de análise. O benchmark principal foi desenvolvido integralmente em linguagem C.
